...
func CreateUrlMappings() {
	...
	{
		rawAPI.GET("", _raw.GetRaw)                             // "/:RESOURCE"                             > core apiGroup - APIResourceList
	...
	{
		rawAPI_.GET("", _raw.GetRaw)                             // "/:RESOURCE"                             > core apiGroup - APIResourceList
	...
	{
		rawAPIs_.GET("", _raw.GetRaw)                             // "/:RESOURCE"                                > apiGroup - APIResourceList
